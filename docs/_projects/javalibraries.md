...
| Application | Version | Description |
|:------------|:--------|:------------|
| [consistgen](https://github.com/UnitVectorY-Labs/consistgen) | [![GitHub release](https://img.shields.io/github/release/UnitVectorY-Labs/consistgen.svg)](https://github.com/UnitVectorY-Labs/consistgen/releases/latest) | This simple Java library provides static and dynamic implementations for generating timestamps, random strings, and UUIDs, offering a structured way to inject predictable data into test cases. |
| [jsonschema4springboot](https://github.com/UnitVectorY-Labs/jsonschema4springboot) | [![GitHub release](https://img.shields.io/github/release/UnitVectorY-Labs/jsonschema4springboot.svg)](https://github.com/UnitVectorY-Labs/jsonschema4springboot/releases/latest) | Add JSON Schema Validation to Spring Boot 3 with Annotations |
